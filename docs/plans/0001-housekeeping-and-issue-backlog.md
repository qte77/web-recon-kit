...
| 11 | A3 · #17 `feat(bola): dotted collection_key and configurable id_field` | A | agent | DONE — merged as PR #<PR_NUMBER>; `Refs #17` + comment (shipped dotted key + id_field; pagination/multi-segment/spec-discovery deferred) |
