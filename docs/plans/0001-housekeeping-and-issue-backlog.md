...
| 13 | B2 · #31 `fix(browser): guard the polyfetch import with an actionable exit-2 hint` | B | agent | DONE — merged as PR #<PR_NUMBER> (owner accepted 2026-09-18, authored by "dntywntme"); local proof: both runners exit 2 with the hint (polyfetch_scrape not installed here); `Refs #31` + comment |
